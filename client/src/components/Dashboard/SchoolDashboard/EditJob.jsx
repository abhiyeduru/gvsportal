...
const EditJob = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axiosInstance.put(`/jobs/${jobId}/update`, formData);
      ...
      <div className="p-6">
        ...
        <div className="mb-6">
          <button
            ...
            className="flex items-center gap-2 text-gray-600 hover:text-[#6C5CE7] transition-colors mb-4"
          >
            <ArrowLeft className="w-5 h-5" />
            <span className="font-medium">Back to Job Posts</span>
          </button>
          <h1 className="text-2xl font-bold text-gray-800 mb-2">Edit Job</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center justify-end space-x-4">
            ...
            >
              ...
              <span>{isSubmitting ? 'Updating...' : 'Update Job'}</span>
            </button>
          </div>
        </form>
      </div>
