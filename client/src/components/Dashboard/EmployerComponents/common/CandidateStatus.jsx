...
const CandidateStatus = ({
  ...
  const steps = [
    ...
    { number: 3, title: "shortlisted" },
    { number: 4, title: "interview" },
    { number: 5, title: "hired" },
    { number: 6, title: "rejected" },
  ];
                  ...
                  <div className="capitalize mb-6">
                    {steps.map((step, index) => (
                      <div key={step.number} className="flex items-start h-16">
                        <div className="flex flex-col items-center">
                          <div
                            className={`w-8 h-8 rounded-full flex items-center justify-center ${step.number < activeStep ||
                              (step.number === steps.length && activeStep === steps.length)
                              ? "bg-green-500"
